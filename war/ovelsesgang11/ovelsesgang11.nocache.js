...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "ovelsesgang11" because\n';
  ...
  $wnd.__gwt_activeModules['ovelsesgang11'] = {
    'moduleName' : 'ovelsesgang11',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/ovelsesgang11.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['ovelsesgang11'].superdevmode = true;

  var expectedSuffix = '/ovelsesgang11.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + ovelsesgang11 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:ovelsesgang11';
  var devModeSessionKey = '__gwtDevModeSession:ovelsesgang11';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/ovelsesgang11/ovelsesgang11.nocache.js';
  ...
  $wnd.__gwt_activeModules['ovelsesgang11'].canRedirect = true;
  $wnd.__gwt_activeModules['ovelsesgang11'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING ovelsesgang11';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/ovelsesgang11?user.agent=' + ua + '&_callback=' + callback;
